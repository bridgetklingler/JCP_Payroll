export default function GetAddHours(){
    return `    
            ...
            <addinput> <label>Time In: <label/> <input type="time" class="add_hours_time_in"> </addinput>
            <addinput> <label> Time Out: <label/> <input type="time" class="add_hours_time_out"> </addinput>
